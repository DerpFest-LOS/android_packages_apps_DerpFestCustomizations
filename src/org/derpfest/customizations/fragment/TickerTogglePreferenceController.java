...
public class TickerTogglePreferenceController extends TogglePreferenceController
    ...
    public boolean isChecked() {
        return Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_NOTIFICATION_TICKER, 1) == 1;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        return Settings.System.putInt(mContext.getContentResolver(),
                Settings.System.STATUS_BAR_NOTIFICATION_TICKER, isChecked ? 1 : 0);
    }
    ...
    private class SettingObserver extends ContentObserver {
        ...
        private final Uri mUri = Settings.System.getUriFor(Settings.System.STATUS_BAR_NOTIFICATION_TICKER);
